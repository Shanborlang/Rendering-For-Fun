...
struct VulkanResources {
    ...
    VkDescriptorSet addDescriptorSet(VkDescriptorPool descriptorPool, VkDescriptorSetLayout dsLayout) const;

    void updateDescriptorSet(VkDescriptorSet ds, const DescriptorSetInfo& dsInfo) const;

    [[nodiscard]] const std::vector<VulkanTexture>& getTextures() const { return allTextures; }
